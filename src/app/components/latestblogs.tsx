    ...
    <section className="bg-black py-2 px-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="text-orange-500 font-medium">Blog Pod</span>
          <h2 className="text-3xl md:text-4xl font-bold text-white mt-2">
            <span className="text-orange-500">L</span>atest News & Blog
          </h2>
        </div>
            ...
            <div key={post.id} className="group cursor-pointer">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">
                  ...
                  <Link 
                    href="#" 
                    className="inline-block text-orange-500 mt-3 hover:text-orange-400"
                  >
                    Learn More
                  </Link>
                </div>
